...
TASK_STATUS_AUTO_CHECKING = "auto_checking"
...
ALLOWED_TASK_TRANSITIONS = {
    ...
    (TASK_STATUS_SUBMITTED, TASK_STATUS_AUTO_CHECKING),
    (TASK_STATUS_REVIEW_PENDING, TASK_STATUS_AUTO_CHECKING),
    (TASK_STATUS_AUTO_CHECKING, TASK_STATUS_REVIEW_PENDING),
    (TASK_STATUS_AUTO_CHECKING, TASK_STATUS_NEEDS_REVISION),
