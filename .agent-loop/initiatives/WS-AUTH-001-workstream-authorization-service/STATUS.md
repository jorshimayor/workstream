...
external checks and explicit human approval. No service caller or feature
action is active.
...
internal review passed at `cc7e6cc`; ready PR #148 external checks and explicit
human approval are the current gate.
