...
| A14 | Future WS-POL work resumes on obsolete auth | Rework and inconsistent authority | Keep future WS-POL chunks inactive until explicit starts and authorization impact is reviewed | Loop-memory gate |
