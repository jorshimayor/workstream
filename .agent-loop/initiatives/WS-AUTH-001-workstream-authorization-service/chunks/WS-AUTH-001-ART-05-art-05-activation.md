# Chunk Contract: WS-AUTH-001-ART-05 — ART 05 Submission Binding Activation
...
Integrate the exact AUTH evaluator contract and activate only `artifact.submission.binding.create` after
...
merged `WS-ART-001-05` hidden manifest, AUTH-09E binding-service admission, and `WS-AUTH-001-ART-CUSTODY`.
...
.agent-loop/merge-intents/WS-AUTH-001-ART-05.json
...
- Allow, wrong-grant, cross-project, inactive actor/link, stale authority,
  ...
  pass as applicable.
- Submission authority does not imply binding-service authority, and the service action does not create submission authority.
