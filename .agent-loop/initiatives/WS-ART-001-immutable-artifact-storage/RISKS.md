...
| ART and AUTH both claim activation custody | Critical | Transfer all 25 current ART mappings to closed AUTH custodians, preserve mappings, remove unused ART owner enums, and reject partial or dual ownership through parity tests. |
