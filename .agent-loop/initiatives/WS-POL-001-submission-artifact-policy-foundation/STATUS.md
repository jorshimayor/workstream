...
in active planning/spec contract review and is implementation-inactive until
human review approves the actor identity/profile implementation boundary.
...
| `WS-POL-001-11` | Contract review active; implementation inactive | `codex/ws-pol-001-11-actor-identity-profile-contract` | - | Defines local Workstream actor identity and actor profile registries for verified Flow actors before the next live API drill. |

## Blockers

| Blocker | Owner | Next action |
|---|---|---|
| None | - | Review and merge the `WS-POL-001-11` contract before implementation starts. |
