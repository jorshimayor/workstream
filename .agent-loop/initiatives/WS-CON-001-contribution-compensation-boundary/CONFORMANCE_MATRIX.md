...
| Operations requests and observation | 10B | bounded durable requests; AdminRole and prepared-protocol proof; audit redaction; same-session outbox/fulfillment counts plus maximum immutable root ordinal; no executor authority | REV-12A + joint drill |
