...
| Contribution cardinality | 03C,07 + REV | one completed_review per valid Review; accept adds accepted_submission; revision Reviews distinct; automated outcomes create none | joint live drill |
...
| Atomic REV/CON | 07 + REV | exact locked request and stabilized digest; CON copies artifact_hash; zero ART calls; every injected failure rolls back Review/task/contribution/award/audit/outbox | joint live drill |
