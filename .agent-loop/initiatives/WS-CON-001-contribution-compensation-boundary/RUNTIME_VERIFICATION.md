...
|---|---|---|
| CON-02A | `app/modules/outbox/*` | `app/modules/outbox app/db/models.py tests/test_outbox.py alembic/versions/<exact-file>.py` |
...
| CON-03B | `app/modules/compensation/*` | `app/modules/compensation app/modules/projects/models.py app/db/models.py tests/test_compensation.py tests/test_projects.py alembic/versions/<exact-file>.py` |
...
| CON-04B | `app/modules/compensation/*` | `app/modules/compensation app/modules/projects/repository.py app/composition/compensation.py tests/test_compensation.py tests/test_projects.py tests/test_authorization.py tests/test_api_contract_e2e.py` |
...
| CON-06 | `app/modules/compensation/*` | `app/modules/compensation tests/test_compensation.py tests/test_authorization.py` |
...
| CON-08B | `app/modules/compensation/*` | `app/modules/compensation app/api/internal_compensation.py app/composition/compensation.py tests/test_compensation.py tests/test_authorization.py tests/test_api_contract_e2e.py` |
| CON-09A | `app/modules/contributions/*`; `app/workers/contribution_evidence.py` | `app/modules/contributions app/modules/outbox/handlers.py app/workers/contribution_evidence.py app/workers/celery_app.py tests/test_contributions.py tests/test_artifacts.py tests/test_outbox.py` |
| CON-09B | `app/modules/contributions/*` | `app/modules/contributions app/api/internal_contributions.py app/composition/contributions.py tests/test_contributions.py tests/test_authorization.py tests/test_api_contract_e2e.py` |
