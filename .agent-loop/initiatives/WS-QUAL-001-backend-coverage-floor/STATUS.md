...
- Phase: `WS-QUAL-001-01B1B-R6` implementation
...
- Active implementation chunk: `WS-QUAL-001-01B1B-R6`
...
Only B1B-R6 is active on the coverage branch. AUTH-02 proceeds independently
