...
- Phase: `WS-QUAL-001-01B1A-R2` implementation
...
- Active implementation chunk: `WS-QUAL-001-01B1A-R2`
...
Only R2 is active on the coverage branch. AUTH-02 may proceed independently
off-main. Do not start 01B1B, 01B2, or chunk 02.
