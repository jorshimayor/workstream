...
- Phase: `WS-QUAL-001-01B1A-R1` implementation
...
- Active implementation chunk: `WS-QUAL-001-01B1A-R1`
...
Only R1 is active on the coverage branch. AUTH-02 may proceed independently
