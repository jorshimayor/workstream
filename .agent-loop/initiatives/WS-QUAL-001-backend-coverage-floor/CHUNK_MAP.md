...
| `WS-QUAL-001-01B1B-R3` | Stdlib symtable lexical closure | L1 | Contract review passed; implementation active |
| `WS-QUAL-001-01B2` | Git provenance, configured baseline evidence, and CI ratchet | L1 | Inactive until B1B-R3 merge/memory plus explicit user start |
