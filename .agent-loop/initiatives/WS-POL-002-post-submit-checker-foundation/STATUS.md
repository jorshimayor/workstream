...
| `WS-POL-002-02` | Active | `codex/ws-pol-002-02-post-submit-derivation` | - | Post-submit derivation agent and resumable setup integration after pre-submit approval/compile. |
