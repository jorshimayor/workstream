...
| Automation writes to protected `main` or another actor rewrites generated authority | Critical | Hard-code and test `automation/loop-memory` as the sole push ref; block deletion and force-push; authenticate every generated file with an Actions-only Ed25519 signing key and reviewed public key; do not create, approve, or merge a bot PR. |
