...
| `WS-ENG-001-04A` | Complete Loop Memory Projections | L1 | Planning and all nine internal tracks pass; awaiting explicit implementation approval |
| `WS-ENG-001-04B` | Signed Explicit Start Events | L1 | Proposed after 04A merge, replay proof, and separate explicit start |
