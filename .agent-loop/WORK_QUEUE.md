...
|---|---|---:|---|
| `WS-QUAL-001-01B1B-R7` | Iterable Provenance | L1 | Proposed after R6 hard-cap stop; contract review pending |
...
Review B1B-R7 before further coverage implementation. AUTH-02 proceeds
