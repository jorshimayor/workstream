...
|---|---|---:|---|
| `WS-QUAL-001-01B1B-R1` | Lexical Binding Closure | L1 | Proposed after B1B circuit stop; contract review pending |
...
Review B1B-R1 before further coverage implementation. AUTH-02 proceeds
