...
|---|---|---:|---|
| `WS-QUAL-001-01B1B-R5` | Single-Pass Abstract Flow | L1 | Contract review passed at `5672971`; implementation active |
...
Implement and review only B1B-R5. AUTH-02 proceeds independently in its
