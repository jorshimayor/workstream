...
|---|---|---:|---|
| `WS-QUAL-001-01B1B-R4` | Complete Symtable Control Flow | L1 | Proposed after R3 proof-fit stop; internal contract review pending |
...
Review B1B-R4 before further coverage implementation. AUTH-02 proceeds
