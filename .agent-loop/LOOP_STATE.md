...
- Active implementation chunk: `WS-QUAL-001-01B1B-R6` provenance closure
...
- Status: B1B stopped at 223/300 lines after its second binding/AST repair
  ...
  incorrect `except*` flow. R6 passed all ten plan tracks at `bfb2d8e` and is
  active as the complete provenance closure.
...
- Current gate: implement and internally review only B1B-R6. 01B2 remains
